    ...
    <main>
      ...
      <section className="reveal" style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(90deg, transparent, rgba(201,147,58,0.05))',
          clipPath: 'polygon(20% 0, 100% 0, 100% 100%, 0 100%)'
        }} />
        <div style={{
          position: 'absolute', bottom: 0, left: 0, width: '30%', height: '100%',
          background: 'linear-gradient(-90deg, transparent, rgba(37,211,102,0.05))',
        ...
        <div style={{position: 'relative', zIndex: 2, maxWidth: '700px', margin: '0 auto'}}>
          ...
          <h2 style={{
            ...
            color: 'white', marginBottom: '20px', fontWeight: 900, lineHeight: 1.15
          }}>
            Ready to Write Your <span style={{color: 'var(--gold-light)'}}>Next Chapter</span>?
          </h2>
          <p style={{
            color: 'rgba(255,255,255,0.7)', fontSize: '18px', marginBottom: '40px', lineHeight: 1.7,
            maxWidth: '550px', margin: '0 auto 40px auto'
          }}>
            Join 500+ successful professionals, scholars, and founders who have entrusted their career stories to our experts. You are one message away from excellence.
          </p>
