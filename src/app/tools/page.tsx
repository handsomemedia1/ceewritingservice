  ...
  return (
    <main className="min-h-screen bg-gold/20">
      ...
      <section className="pt-40 pb-20 bg-bg-main text-gold relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-bg-main/10/10 blur-[120px] rounded-full pointer-events-none" />
        <div className="container mx-auto px-6 relative z-10 max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 leading-tight">
            Work Smarter, <br className="hidden md:block"/> Not Harder
          </h1>
          <p className="text-lg md:text-xl text-gold/70 max-w-2xl mx-auto leading-relaxed">
