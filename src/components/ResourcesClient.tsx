...
import { FileText, PenTool, Search, BarChart3, Download, Star, BookOpen, CheckCircle2 } from 'lucide-react';
    ...
    <section style={{ background: 'var(--cream)', padding: '80px 24px 100px' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 2, flexDirection: 'column', alignItems: 'center', maxWidth: '700px', margin: '0 auto' }}>
            <div style={{
              width: '64px', height: '64px', borderRadius: '50%', background: 'rgba(201,147,58,0.1)',
              display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '24px',
              border: '1px solid rgba(201,147,58,0.2)', margin: '0 auto 24px',
            }}>
