...
export default function ExpertGuidance() {
  return (
    <Card variant="solid" className="p-8 bg-bg-main text-white mt-6 shadow-lg">
      ...
      <Link href="/services" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-bg-main/10 text-text-primary font-bold hover:bg-bg-main/10-light transition-colors">
        Book a Consultation
      </Link>
    </Card>
  );
