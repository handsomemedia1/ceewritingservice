      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 relative">
             <div className="absolute inset-0 bg-bg-main/5 blur-[80px] rounded-full" />
             <Card variant="glass-light" className="p-8 relative z-10">
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-border/5">
                  <div className="w-12 h-12 rounded-full bg-bg-main flex items-center justify-center text-white">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                  </div>
                  <div>
                    <div className="font-bold text-text-primary">Research Proposal Review</div>
                    <div className="text-sm text-muted">Awaiting Expert Feedback</div>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="h-4 bg-bg-main/5 rounded w-full"></div>
                  <div className="h-4 bg-bg-main/5 rounded w-5/6"></div>
                  <div className="h-4 bg-bg-main/5 rounded w-4/6"></div>
                </div>
          ...
          <div className="order-1 lg:order-2">
            <span className="text-text-primary/70 font-bold tracking-wider uppercase mb-4 block text-sm">The Research Hub</span>
            ...
            <ul className="space-y-4 mb-10 text-muted">
              <li className="flex items-start gap-3">
                <span className="text-text-primary/70 mt-1">✓</span>
            ...
            <Link href="/services" className="inline-flex items-center text-text-primary font-semibold hover:text-text-primary/70 transition-colors">
